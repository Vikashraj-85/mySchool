...
const DegreeCollegeform = () => {
    ...
    return (
        <div className='my-5  py-5 '>
            <h1 className='text-center text-3xl font-medium mt-2 mb-7 underline text-[#00A6FB]'>Place Your Degree College</h1>
            <div className='mb-5'>
...
export default DegreeCollegeform;
